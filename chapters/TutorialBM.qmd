...
# 3. Analyzing an ecological data set

## 3.A. The data set: antagonistic tree/fungus interaction network
...
## 3.B. Analysis of the tree/tree data
...
### 3.B.3  Analysis of the weighted interaction network
...
### 3.B.4 Introduction of covariates
...
## 3.C Analysis of the tree/fungi data
